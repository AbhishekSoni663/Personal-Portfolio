      ...
      <Box className="hero-box3">
        <Box className="hero-box3-1">
          <Fade delay={1e3} direction="center" cascade damping={1e-1}>
            <Typography padding={"5px"} style={{ fontFamily: "Niramit, sans-serif", textAlign: "center", fontSize: "1.4em", fontWeight: "500" }}>Follow Me</Typography>
        ...
        <Box className="hero-box-3-2" >
          <Fade cascade delay={1e3} damping={1e-1} >
            <Typography padding={"5px"} style={{ fontFamily: "Niramit, sans-serif", fontSize: "1.4em", fontWeight: "500", textAlign: 'center' }}>My Work Space</Typography>
